...
function Countdown({
  ...
  const [countdown, setCountdown] = useState(
    diffCalculation(value ?? to - counter, type),
  )
  ...
  useInterval(
    ...
    isPaused ? undefined : refreshRateMs,
    clear,
  )
    ...
    >
      {showPartYears && (
        <>
          {_separator}
          <div
            className={twMerge('flex flex-col items-center', partsClassName)}
          >
            <span>
              {formatYears(showAsYears ? countdown.asYears : countdown.years)}
            </span>
      ...
      {showPartMonths && (
        <>
          ...
          >
            <span>
              {formatMonths(
                showAsMonths ? countdown.asMonths : countdown.months,
              )}
            </span>
      ...
      {showPartWeeks && (
        <>
          ...
          >
            <span>
              {formatWeeks(showAsWeeks ? countdown.asWeeks : countdown.weeks)}
            </span>
      ...
      {showPartDays && (
        <>
          ...
          >
            <span>
              {formatDays(showAsDays ? countdown.asDays : countdown.days)}
            </span>
      ...
      {showPartHours && (
        <>
          ...
          >
            <span>
              {formatHours(showAsHours ? countdown.asHours : countdown.hours)}
            </span>
      ...
      {showPartMins && (
        <>
          ...
          >
            <span>
              {formatMins(showAsMins ? countdown.asMinutes : countdown.minutes)}
            </span>
      ...
      {showPartSecs && (
        <>
          ...
          >
            <span>
              {formatSecs(showAsSecs ? countdown.asSeconds : countdown.seconds)}
            </span>
      ...
      {showPartMs && (
        <>
          ...
          >
            <span>
              {formatMs(
                showAsMs ? countdown.asMilliseconds : countdown.milliseconds,
              )}
            </span>
