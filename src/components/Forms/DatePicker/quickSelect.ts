  ...
  getDate: () => {
    return {
      ...
      value: {
        ...
        end: dayjs().endOf('week').subtract(1, 'week').format(),
      },
    }
  },
  getViewDate: () => {
...
export const lastMonthOption: QuickSelectOption = {
  ...
  getDate: () => {
    return {
      type: 'range',
      value: {
        start: dayjs().startOf('month').subtract(1, 'month').format(),
        end: dayjs().startOf('month').subtract(1, 'day').format(),
      },
    }
  },
  getViewDate: () => {
...
export const lastYearOption: QuickSelectOption = {
  ...
  getDate: () => {
    return {
      type: 'range',
      value: {
        start: dayjs().startOf('year').subtract(1, 'year').format(),
        end: dayjs().startOf('year').subtract(1, 'day').format(),
      },
    }
  },
  getViewDate: () => {
