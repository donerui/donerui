...
export default forwardRef(function TextArea(
  ...
  return (
    <div
      className={twMerge(
        textAreaClasses.wrapper.default,
        hasError && textAreaClasses.wrapper.error,
      )}
    >
      {hasLabel && (
        <label
          className={twMerge(
            textAreaClasses.label.default,
            hasError && textAreaClasses.label.error,
          )}
          htmlFor={id ?? name}
        >
          {label}
      ...
      >
        ...
        <textarea
          ...
          ref={ref}
          className={twMerge(
            textAreaClasses.textarea.default,
            hasError && textAreaClasses.textarea.error,
          )}
        />
