...
export const textAreaClasses = {
  ...
  container: {
    ...
    focusControlled: twMerge('ring-2 ring-primary-600'),
    focusWithin: twMerge('focus-within:ring-2 focus-within:ring-primary-600'),
    error: twMerge(
    ...
    errorFocusControlled: twMerge('ring-red-500 text-red-800'),
  ...
  textarea: {
    ...
    error: twMerge('placeholder:text-red-300'),
  },
  errorText: {
