...
export const selectClasses = {
  ...
  selectedOption: twMerge('text-gray-900', 'data-[error=true]:text-red-700'),
  placeholder: twMerge(
  ...
  dropdown: twMerge(
    'absolute w-full bg-white border border-gray-300 rounded-md shadow-lg overflow-y-auto z-50',
  ...
  errorText: twMerge('text-sm text-red-600'),
}
