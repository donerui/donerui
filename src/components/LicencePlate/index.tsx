  ...
  return (
    ...
    >
      {loc?.codeContainers
        ...
        .map((c, i) => {
          const CodeContainerComponent =
            c.Component ?? LicencePlateCodeContainer
          return (
            <CodeContainerComponent
              key={`code-container-${i.toString()}`}
              locale={loc}
      ...
      {plate.split(plateSplitter).map((part, i) => (
        <Fragment key={`plate-part-${i.toString()}`}>
          <div
            className={twMerge(
          ...
          {loc?.codeContainers
            ...
            .map((c, j) => {
              ...
              return (
                <CodeContainerComponent
                  key={`code-container-${i.toString()}-${j.toString()}`}
                  locale={loc}
                  regionCode={regionCode}
                  {...c}
                />
      ...
      {loc?.codeContainers
        ...
        .map((c, i) => {
          ...
          return (
            <CodeContainerComponent
              key={`code-container-end-${i.toString()}`}
              locale={loc}
              regionCode={regionCode}
              {...c}
            />
